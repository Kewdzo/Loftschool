...
export function* handleReg() {
    yield takeEvery(registration, function* (action) {
...
export function* handleRoute() {
    yield takeEvery(getRoute, function* (action) {
...
export function* handleAddreses() {
    yield takeEvery(getAddressList, function* () {
...
export function* handlePostCard() {
    yield takeEvery(postCard, function* (action) {
